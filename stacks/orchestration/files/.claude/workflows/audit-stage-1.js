...
const SKILL = '{{harness.skillsDir}}/audit/SKILL.md'
...
const architecture = await agent(
  ...
  { label: 'architecture', agentType: '{{roster.architectAgent}}', schema: FINDINGS },
)
...
const security1 = await agent(
  ...
  { label: 'security-1', agentType: '{{roster.securityAgent}}', schema: FINDINGS },
)
