...
| Task | Command |
|------|---------|
| test | `npm test` (node:test, `installer/test/*.test.mjs`; 1500 tests, 207 suites (2 skipped: the #445 per-target check for `codex` / `agents-dir`, whose rosters are null)) |
