...
git -c user.name="Wafflebot" -c user.email=bot@wafflenet.io checkout -b chore/bump-X.Y.Z
```
...
git -c user.name="Wafflebot" -c user.email=bot@wafflenet.io push -u origin chore/bump-X.Y.Z
```
