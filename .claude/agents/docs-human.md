...
Follow the `docs-human` skill for the file set and format rules; follow the `schema/FORMAT.md` skill for the conventions you are describing. When committing doc changes, follow the `git-workflow` skill if the project has one.
